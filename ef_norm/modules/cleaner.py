...
from ef_norm import ALLOW_EXCL, CustomCommandHandler, dispatcher
from ef_norm.modules.disable import DisableAbleCommandHandler
from ef_norm.modules.helper_funcs.chat_status import (
    bot_can_delete,
    connection_status,
    dev_plus,
    user_admin,
)
from ef_norm.modules.sql import cleaner_sql as sql
...
__help__ = """
 • /cleanblue <on/off/yes/no>*:* Command එකක් දැම්මාම auto delete වෙනවා.
 • /ignoreblue <word>*:* Auto delete නොවෙන්නෙ ඕන command.
 • /unignoreblue <word>*:* Auto delete නොවෙන්නෙ ඕන command අයින් කරන්න.
 • /listblue*:* Whitelist එකේ තියෙන command බලන්න
