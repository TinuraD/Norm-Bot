...
from ef_norm import telethn as bot
from ef_norm.modules.urluploader import download_file
from ef_norm.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @ef_normbot",
            )
        except Exception as e:
            traceback.print_exc()
