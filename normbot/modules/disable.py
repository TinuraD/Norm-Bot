...
from normbot.functions.handlers import CMD_STARTERS, SpamChecker
from normbot.functions.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from normbot.utils.sql import disable_sql as sql
