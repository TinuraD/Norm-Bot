...
from normbot import pbot as bot
        ...
        if message.chat.id>0:
            ...
            if 0<user_input_time<=10:
                while user_input_time and not stoptimer:
                    ...
                    rose_text='{}\n\n⏳ {:02d**s**'.format(user_input_event, s)
                ...
                while user_input_time>0 and not stoptimer:
                    ...
                    s=user_input_time%60
                    rose_text='{}\n\n⏳ {:02d}**m** : {:02d}**s**'.format(user_input_event, m, s)
                    finish_countdown = await get_user_input_time.edit(rose_text)
                    await asyncio.sleep(3)
                    user_input_time -=3
                await finish_countdown.edit("🚨 Beep! Beep!! **TIME'S UP!!!**")
                ...
                while user_input_time>0 and not stoptimer:
                    ...
                    m=user_input_time%3600//60
                    s=user_input_time%60
                    rose_text='{}\n\n⏳ {:02d}**h** : {:02d}**m** : {:02d}**s**'.format(user_input_event, h, m, s)
                    finish_countdown = await get_user_input_time.edit(rose_text)
                ...
                while user_input_time>0 and not stoptimer:
                    ...
                    m=user_input_time%3600//60
                    s=user_input_time%60
                    rose_text='{}\n\n⏳ {:02d}**d** : {:02d}**h** : {:02d}**m** : {:02d}**s**'.format(user_input_event, d, h, m, s)
                    finish_countdown = await get_user_input_time.edit(rose_text)
