...
import normbot.modules.sql.userinfo_sql as sql
from normbot import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from normbot import telethn as SaitamaTelethonClient
from normbot.__main__ import STATS, TOKEN, USER_INFO
from normbot.modules.disable import DisableAbleCommandHandler
from normbot.modules.helper_funcs.chat_status import sudo_plus
from normbot.modules.helper_funcs.extraction import extract_user
from normbot.modules.sql.afk_sql import check_afk_status, is_afk
from normbot.modules.sql.global_bans_sql import is_user_gbanned
from normbot.modules.sql.users_sql import get_user_num_chats
