...
import normbot.utils.sql.global_bans_sql as sql
from normbot import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from normbot.functions.misc import send_to_list
from normbot.utils.sql.users_sql import get_user_com_chats
