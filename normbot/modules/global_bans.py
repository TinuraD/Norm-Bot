...
import normbot.modules.sql.global_bans_sql as sql
from normbot import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from normbot.modules.helper_funcs.misc import send_to_list
from normbot.modules.sql.users_sql import get_user_com_chats
