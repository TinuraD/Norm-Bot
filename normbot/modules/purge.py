...
from normbot import DEV_USERS, telethn
from normbot.modules.helper_funcs.telethn.chatstatus import (
    can_delete_messages,
    user_is_admin,
)
...
async def delete_messages(event):
    ...
    __help__ = """
*Admin only:*
 • /del - Reply කරපු message එක delete  කරන්න.
 • /purge - Reply කරපු එකේ ඉදන් command එක දාපු තැන වෙනක් තියෙන message delete කරන්න.
